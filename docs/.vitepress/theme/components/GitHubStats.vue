...
async function fetchStats() {
  try {
    // Fetch repo stats
    const repoResponse = await fetch('https://api.github.com/repos/build-workbench/dig-your-windows')
    if (repoResponse.ok) {
    ...
    const releasesResponse = await fetch('https://api.github.com/repos/build-workbench/dig-your-windows/releases')
